...
: _file_name(file_name)
{
   ...
   if ((this->_numerical_flux_choice != "centered") && (this->_numerical_flux_choice != "upwind") && (this->_numerical_flux_choice != "SG"))
   {
      cout << "Only centered and upwind numerical flows are implemented." << endl;
      exit(0);
   }

   if ((this->_scheme != "ExplicitEuler") && (this->_scheme != "ImplicitEuler") && (this->_scheme != "CrankNicholson"))
   {
